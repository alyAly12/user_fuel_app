    ...
    return Row(
      ...
      children: [
        Column(
          children: [
            CustomToggleButton(
              ...
              border:_gas91 ? Border.all(color: Colors.transparent, width:1.2)
                  : Border.all(color: AppColors.orderNumberColor, width: 1.2),
              onTap: (){
                setState(() {
                  _gas91 =!_gas91;
                });
            ...
            CustomToggleButton(
              ...
              border:_diesel ? Border.all(color: Colors.transparent, width: 1.2)
                  : Border.all(color: AppColors.orderNumberColor, width: 1.2),
              onTap: (){
                setState(() {
                  _diesel =!_diesel;
        ...
        CustomToggleButton(
          ...
          border:_gas95 ? Border.all(color: Colors.transparent, width: 1.2)
              : Border.all(color: AppColors.orderNumberColor, width: 1.2),
          onTap: (){
            setState(() {
              _gas95 =!_gas95;
